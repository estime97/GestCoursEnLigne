...
namespace BlazorHero.CleanArchitecture.Shared.Constants.Permission
{
    public static class Permissions
    {
        ...
        [Description("Requisitions Permissions")]
        public static class Requisitions
        {
            public const string Import = "Permissions.Requisitions.Import";
            public const string Synchronize = "Permissions.Requisitions.Synchronize";
            public const string Export = "Permissions.Requisitions.Export";
            public const string Update = "Permissions.Requisitions.Update";
